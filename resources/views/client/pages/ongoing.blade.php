                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p><a href="/">Projects </a> &nbsp;/&nbsp; <span>Current Projects</span></p>
                                </div>
                        ...
                        <div class="item col-lg-3 col-md-6 col-xs-12 landscapes sale">
                            <div class="project-single mb-0" data-aos="fade-up">
                                <a href="{{ route('details.view', $project->project->project_id) }}"  class="recent-16 w-ds99">
                                    {{-- <div class="recent-img16 img-center" style="background-image: url( {{ asset('storage/images/' . $project->images[0]->image_name) }} );">
                                </div> --}}
                                    ...
                                    <div class="recent-details">
                                        <div class="recent-title">{{ $project->project->project_name }}</div>
                                        <div class="recent-price">{{ $project->project->location }}</div>
