            ...
            <div class="banner_box_wrapper">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-5 col-md-5 align-self-center d-flex pr-0 side-map-index">
                            <!--=== Swiper ===-->
                            <div class="hover-menu d-flex">
                                <div class="hover-menu-listing" id="barisal">
                                    <h2 class="hover-menu-title">{{ $projects[0]->project->dist }}</h2>
                                    @foreach ($projects as $key => $project)
                                        <a href="#"
                                            onclick="getId(event, '{{ $project->project->project_id }}', this)"
                                            class="hover-menu-listing-element {{ $loop->first ? 'bg-success' : '' }} mb-1">
                            ...
                            @php
                                $imageNames = explode('|', $projects[0]->image_name);
                                $firstImage = isset($imageNames[0]) ? $imageNames[0] : null;
                            @endphp
                            <div class="hover-sub-menu" id="hover_sub">
                                <h3 class="hover-sub-menu-title">{{ $projects[0]->project->project_name }}</h3>
                                <div class="line-fox"></div>
                                <div class="image">
                                    <img id="project_image" src="{{ asset('images/uploads/' . $firstImage) }}"
                                        alt="">
                                </div>
                                <p class="px-4 description_under_image">{{ $projects[0]->project->description }}</p>
                                <div class="content">
                                    <p class="content-item new_location"><i
                                            class="fa fa-map-marker mr-3"></i>{{ $projects[0]->project->location }},{{ $projects[0]->project->dist }}
                                    </p>
                                    <p class="content-item new_date">
                                        <i class="fa-solid fa-clock mr-3" aria-hidden="true"></i>
                                        {{ \Carbon\Carbon::parse($projects[0]->project->created_at)->format('d M Y') }}
                                    </p>
                                </div>
                                <a href="{{ route('details.view', $projects[0]->project->project_id) }}" id="view_details"
                                    class="button border text-center mt-3 mx-4">Details view</a>
                            </div>
                        </div>
                        {{-- @else
                        <h3>No Data Found</h3>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="swiper_imgbox imgbox2">
                                                <div class="swipper_img">
                                                    <h4>Our Projects <span>SABEL</span></h4>
                                                    <h2>Dr. M. A. Wazed Miah IICT Building in SUST</h2>
                                                    <h3>Architecture<span class="banner_span1"></span></h3>
                                                    <p><i class="fa fa-map-marker mr-3"></i>SUST, Sylhet</p>
                                                    <!-- homes List -->
                                                    ...
                                                    <a href="/bx1" class="int_btn">View Details
                                                        <span class="btn_caret"><i
                                        ...
                                        <div class="swiper-slide">
                                            <div class="swiper_imgbox imgbox1">
                                                <div class="swipper_img">
                                                    <h4>Our Projects <span>SABEL</span></h4>
                                                    <h2>Multipurpose Poura Super Market</h2>
                                                    <h3>Architecture<span class="banner_span1"></span></h3>
                                                    <p><i class="fa fa-map-marker mr-3"></i>PIU Office of Laksam
                                                        Pourashava, Cumilla</p>
                                                    <!-- homes List -->
                                                    <ul class="homes-list clearfix">
                                                        <li>
                                                            <i class="fa-solid fa-clock" aria-hidden="true"></i>
                                                    ...
                                                    <a href="/bx2" class="int_btn">View Details
                                                        <span class="btn_caret"><i
                                                                class="fas fa-caret-right"></i></span></a>
                                                    <h1>Sabel</h1>
                                                </div>
                                ...
                                <div class="swiper-container" data-aos="fade-left">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="swiper_contbox">
                                                <div class="swipper_conntent">
                                                    <img src="/Client/plots/Front1.jpg" class="img-fluid"
                                                        alt="images" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="swiper_contbox">
                                                <div class="swipper_conntent">
                                                    <img src="/Client/plots/Front.jpg" class="img-fluid"
                                                        alt="images" />
                                                </div>
                                            </div>
                                        </div>
                    ...
                    @foreach ($projects_all as $project)
                        <div class="agents-grid">
                            <div class="landscapes listing-item compact thehp-1" data-aos="fade-up" data-aos-delay="150">
                                <a href="{{ route('details.view', $projects[0]->project->project_id) }}" class="recent-16">
                                    @foreach (explode('|', $project->image_name) as $key => $image)
                                        @if ($key == 0)
                                ...
                                <div class="recent-details">
                                    ...
                                    <div class="recent-price mb-3">{{ $project->project->employee }}</div>
                                </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function addLabels() {
            ...
            paths.forEach(function(path) {
                ...
                if (!name) return;
                var center = calculateCenter(path);

                // Create group element to hold text and icon
                var group = document.createElementNS('http://www.w3.org/2000/svg', 'g');
                
                // Create text element
                var text = document.createElementNS('http://www.w3.org/2000/svg', 'text');
                text.setAttribute('x', center.x -5); // Adjusted to make room for the icon
                text.setAttribute('y', center.y);
                text.setAttribute('text-anchor', 'start'); // Align to the left of the icon
                ...
                icon.setAttribute('x', center.x - 15); // Adjusted to position icon before the text
                icon.setAttribute('y', center.y);
                icon.setAttribute('text-anchor', 'middle');
                icon.setAttribute('fill', 'red');
                icon.setAttribute('font-size', '13px');
                icon.setAttribute('dominant-baseline', 'middle');
                icon.setAttribute('font-family', 'FontAwesome'); // Ensure FontAwesome is loaded
                icon.textContent = '\uf3c5'; // Unicode for the Font Awesome location-dot icon

                // Append text and icon to group
...
<!-- Ensure to include the Font Awesome stylesheet in your HTML -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
            ...
            <script>
                function sendMessage(cityName) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (!response || !response.projects_with_images || response.projects_with_images.length === 0) {
                                $("#barisal").empty().append('<p class="text-center align-items-center">No data found</p>');
                                $("#hover_sub").empty();
                                return;
                            }
                            else{
                            $("#barisal").empty();
                            $("#hover_sub").empty();
                            var newTitle = $('<h2>').addClass('hover-menu-title').text(response.projects_with_images[0]
                                .project.dist);
                            $("#barisal").append(newTitle);

                            var projectLinks = "";
                            response.projects_with_images.forEach(function(project, index) {
                                var className = (index === 0) ? 'hover-menu-listing-element bg-success mb-1' :
                                    'hover-menu-listing-element mb-1';
                                projectLinks += '<a href="#" class="' + className + '" onclick="getId(event, ' +
                                    project.project.project_id + ', this)">' +
                                    project.project.project_name +
                                    '</a>';
                            });
                            $("#barisal").append(projectLinks);

                            var titleElement = $('<h3>').addClass('hover-sub-menu-title').text(response.projects_with_images[0]
                                .project.description);
                            var lineElement = $('<div>').addClass('line-fox');
                            var imageNames = response.projects_with_images[0].images[0].image_name;
                            var firstImageName = imageNames.split('|')[0];
                            var imagePath = "./images/uploads/" + firstImageName;
                            $("#project_image").attr("src", imagePath);
                            ...
                            var imageContainer = $('<div>').addClass('image').append(imageElement);

                            var descriptionParagraph = $('<p>').addClass('px-4 description_under_image').text(response.projects_with_images[0]
                                .project.description);   
                            var contentContainer = $('<div>').addClass('content');

                            let new_date = (response.projects_with_images[0]
                                .project.created_at)
                            var formattedDate = moment(new_date).format('DD MMM YYYY');

                            var locationItem = $('<p>').addClass('content-item new_location').html('<i class="fa fa-map-marker mr-3"></i>' + response.projects_with_images[0]
                            .project.location + ', ' + response.projects_with_images[0]
                            .project.dist);

                            var dateItem = $('<p>').addClass('content-item new_date').html('<i class="fa-solid fa-clock mr-3" aria-hidden="true"></i>' +formattedDate);
                            
                            contentContainer.append(locationItem, dateItem);

                            var projectId =response.projects_with_images[0].project.project_id;

                            var detailsLink = $('<a>').attr({
                                'id': 'view_details',
                                'href': '/details-view/' + projectId,
                                'class': 'button border text-center mt-3 mx-4'
                            }).text('Details view');

                            var containerDiv = $('<div>').append(titleElement, lineElement, imageContainer, descriptionParagraph, contentContainer, detailsLink);

                            $("#hover_sub").html(containerDiv);
                            }
                        },
                ...
                $(".hox").click(function() {
                    var cityName = $(this).attr("class").split(" ")[
                        1];
                    sendMessage(cityName);
                });

                function getId(event, id, element) {
                    event.preventDefault();
                    var links = document.querySelectorAll('.hover-menu-listing-element'); // Get all links
                    for (var i = 0; i < links.length; i++) {
                        links[i].classList.remove('bg-success'); // Remove bg-success class from all links
                    }
                    element.classList.add('bg-success');
                    $.ajax({
                        url: "{{ route('project.projectmap_item') }}",
                        type: "GET",
                        data: {
                            project_id: id
                        },
                        success: function(response) {
                            ...
                            //console.log(response.project[0].project.description);
                            // $("#hover_sub #view_details").remove();
                            let new_description = (response.project[0]
                                .project.description)
                            let tt=(response.project[0]
                                .project.project_name)
                            $(".hover-sub-menu-title").text(tt);
                            $(".description_under_image").text(new_description);

                            // var imageName = response.project[0].images[0].image_name;
                            // var imagePath = "images/uploads/" + imageName;
                            // $("#project_image").attr("src", imagePath);


                            var imageNames = response.project[0].images[0].image_name;
                            var firstImageName = imageNames.split('|')[0];
                            var imagePath = "images/uploads/" + firstImageName;
                            $("#project_image").attr("src", imagePath);


                            let new_date = (response.project[0]
                                .project.created_at)

                            let new_location = response.project[0]
                                .project.location;
                            let new_dist = response.project[0]
                                .project.dist;
                            var content = '<i class="fa fa-map-marker mr-3"></i>' + new_location + ', ' + new_dist;
                            $(".new_location").html(content);
                            var projectId = response.project[0].project.project_id;

                            // var className = "hover-menu-listing-element";
                            // var projectLink = '<a href="{{ route('details.view', ['dist' => ':projectId']) }}'+ '" class="' + className + '">View Details</a>';
                            var link = document.getElementById('view_details');
                            link.href = "/details-view/" + projectId;
