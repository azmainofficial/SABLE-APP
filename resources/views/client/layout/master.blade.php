...
<head>
    ...
    <title>Sayed Ali Builders and Engineers Ltd</title>
    <!-- FAVICON -->
...
<body class="int_dark_bg">
    ...
    <div id="wrapper" class="int_main_wraapper">
        ...
        <script src="/Client/js/forms-2.js"></script>
        <script src="/Client/js/color-switcher.js"></script>

        <script src="/Client/js/counterup.js"></script>
        <script src="/Client/js/inner.js"></script>


        <!-- Slider Revolution scripts -->
        <script src="/Client/js/jquery.themepunch.tools.min.js"></script>
        <script src="/Client/js/jquery.themepunch.revolution.min.js"></script>
